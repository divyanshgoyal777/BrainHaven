      ...
      <main className="mt-36 px-4 md:px-16 lg:px-24">
        ...
        <section className="Page-2 my-24 flex flex-col justify-center items-center text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-3xl">
            ...
            resources, expert roadmaps, and hackathons. Whether you're learning
            to code, preparing for a hackathon, or exploring the latest tech
            trends, we've got everything you need.
          </p>
        </section>
