...
const ResourcesUpload = () => {
  ...
  const sameResources = async (e, response) => {
    ...
    if (response === "yes") {
      ...
      try {
        const response = await axios.post("http://localhost:3000/api/resource/replace", formDataToSend, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
        ...
        if (error.response) {
          ...
          setUploadStatus(error.response.data.message || "Error during file upload.");
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!option ? (
          ...
          <div className="max-w-[35vw] mx-auto bg-gray-800 p-6 rounded-lg shadow-lg space-y-6">
            ...
            <p className="text-center font-semibold my-4 max-w-[80%] m-auto">These Details is already exist. Click on "Yes" if you want to replace the file with that detail.</p>
