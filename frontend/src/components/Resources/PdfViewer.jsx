      ...
      <div className="flex flex-col items-center mt-10 gap-3 sm:gap-5">
        {pdfUrls.map((url, index) => (
          ...
          >
            ...
            <p className="text-white absolute bottom-2 right-[1rem] sm:right-[6.7rem] md:text-sm text-[10px] bg-slate-600 h-6 w-6 flex items-center justify-center rounded-full">
              {index + 1}
            </p>
